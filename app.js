...
$("$("customerTable").innerHTML=data.customers.map(x=>`<tr><td>${esc(x.ID)}</td><td>${esc(x.Name)}</td><td>${esc(x.Phone)}</td><td>${esc(x.Address)}</td><td><button onclick="editCustomer('${esc(x.ID)}')">✏️ Edit</button><button onclick="deleteCustomer('${esc(x.ID)}')">🗑️ Delete</button></td></tr>`).join("");").innerHTML=data.customers.map(x=>`<tr><td>${esc(x.ID)}</td><td>${esc(x.Name)}</td><td>${esc(x.Phone)}</td><td>${esc(x.Address)}</td><td><button onclick="editCustomer('${esc(x.ID)}')">✏️ Edit</button><button onclick="deleteCustomer('${esc(x.ID)}')">🗑️ Delete</button></td></tr>`)=data.customers.map(x=>`<tr><td>${esc(x.ID)}</td><td>${esc(x.Name)}</td><td>${esc(x.Phone)}</td><td>${esc(x.Address)}</td><td><button onclick="editCustomer('${esc(x.ID)}')">✏️ Edit</button><button onclick="deleteCustomer('${esc(x.ID)}')">🗑️ Delete</button></td></tr>`).join("");"$("customerTable").innerHTML=data.customers.map(x=>`<tr><td>${esc(x.ID)}</td><td>${esc(x.Name)}</td><td>${esc(x.Phone)}</td><td>${esc(x.Address)}</td><td><button onclick="editCustomer('${esc(x.ID)}')">✏️ Edit</button><button onclick="deleteCustomer('${esc(x.ID)}')">🗑️ Delete</button></td></tr>`).join("");").innerHTML=data.customers.map(x=>`<tr><td>${esc(x.ID)}</td><td>${esc(x.Name)}</td><td>${esc(x.Phone)}</td><td>${esc(x.Address)}</td></tr>`).join("");$("vendorTable").innerHTML=data.vendors.map(x=>`<tr><td>${esc(x.ID)}</td><td>${esc(x.Name)}</td><td>${esc(x.Phone)}</td><td>${esc(x.Address)}</td><td><button onclick="editVendor('${esc(x.ID)}')">✏️ Edit</button><button onclick="deleteVendor('${esc(x.ID)}')">🗑️ Delete</button></td></tr>`).join("");
                     $("vendorTable").innerHTML=data.vendors.map(x=>`<tr><td>${esc(x.ID)}</td><td>${esc(x.Name)}</td><td>${esc(x.Phone)}</td><td>${esc(x.Address)}</td><td><button onclick="editVendor('${esc(x.ID)}')">✏️ Edit</button><button onclick="deleteVendor('${esc(x.ID)}')">🗑️ Delete</button></td></tr>`).join("");

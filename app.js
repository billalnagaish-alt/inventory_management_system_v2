...
$("customerTable").innerHTML=data.customers.map(x=>`<tr><td>${esc(x.ID)}</td><td>${esc(x.Name)}</td><td>${esc(x.Phone)}</td><td>${esc(x.Address)}</td></tr>`).join("");$("vendorTable").innerHTML=data.vendors.map(x=>`<tr><td>${esc(x.ID)}</td><td>${esc(x.Name)}</td><td>${esc(x.Phone)}</td><td>${esc(x.Address)}</td></tr>`).join("");
